import { ALM_GRAPH_URL } from '../config/graphql-urls';
import { SupportedChainId } from '../types';

export default function getGraphUrls(chainId: SupportedChainId, isGraphRequired?: boolean): { url: string } {
  const url = ALM_GRAPH_URL[chainId];
  // const publishedUrl =
